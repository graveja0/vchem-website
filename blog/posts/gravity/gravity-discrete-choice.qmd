...
subtitle: "Part 1: The Equivalence Between Random Utility and Gravity Model Frameworks for Discrete Choice"
...
In this blog series, we resurrect a forty-year-old paper in transportation
research (@anas1983) to demonstrate the equivalence between the
conditional logit and a gravity model.[^followon] In other words, for
a given set of patient and provider attributes, a conditional logit and
